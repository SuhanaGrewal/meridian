...
SYSTEM_PROMPT = (
    ...
    "anything); a question; or a commitment some third party made that's "
    "merely mentioned in passing. The test is always \"did the person who "
    "wrote this email promise to personally do something themselves\" - if "
    "the action belongs to the recipient or anyone else, it is not a "
    "commitment.\n\n"
