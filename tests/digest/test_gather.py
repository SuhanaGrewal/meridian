...
def _message() -> ParsedMessage:
    return ParsedMessage(
        message_id="msg-1", thread_id="t-1", subject="Budget", sender="jane@example.com",
        recipients=[], sent_at="2024-06-05T00:00:00Z",
        body_text="x" * 600, label_ids=["INBOX"], content_hash="hash-1",
    )
